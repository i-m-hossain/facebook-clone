<template>
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        ...
        <div class="flex justify-between border-1 border-gray-400 m-4">
            <button @click="$store.dispatch('likePost', {postId:post.data.post_id, postKey: $vnode.key} )" class="flex justify-center py-2 rounded-lg text-sm  w-full focus:outline-none" 
